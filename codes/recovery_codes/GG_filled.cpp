...
/*
this program is to replace the empty snps in input file with homozygous pairs GG
...
int main(){
	...
	string suffix="txt";
	string suffix2="csv";
	string outputfile="GG_"+inputfile+"."+suffix;
			...
			while (true){
				...
				if (i==3){
					...
					if (data=="--" && j<min-exist[chrom-1]){
						data="GG";//replace the empty pair with random one
						j++;
					}
					line=line+data;
