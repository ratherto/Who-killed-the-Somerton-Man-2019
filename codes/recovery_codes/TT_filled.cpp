...
/*
this program is to replace the empty snps in input file with homozygous pairs TT
...
int main(){
	...
	string suffix="txt";
	string suffix2="csv";
	string outputfile="TT_"+inputfile+"."+suffix;
			...
			while (true){
				...
				if (i==3){
					...
					if (data=="--" && j<min-exist[chrom-1]){
						data="TT";//replace the empty pair with random one
						j++;
					}
					line=line+data;
